/**
 * ┌────────────────────────────────────────────────────────────────────────────┐
 * │ ⚠️  NOTE: Some rules in this file are legacy and do NOT work with          │
 * │      @eslint-react/eslint-plugin. They are from the old                    │
 * │      eslint-plugin-react and are kept for reference or migration.          │
 * │                                                                            │
 * │      Only a subset of rules here are compatible with                       │
 * │      @eslint-react/eslint-plugin.                                          │
 * │                                                                            │
 * │      Please review and update rules as needed.                             │
 * └────────────────────────────────────────────────────────────────────────────┘
 */
...
export const reactRulesOverride: Rules = {
  ...
  // NOTE: This rule doesn't exist in @eslint-react/eslint-plugin, commenting out for now
  ...
  // NOTE: This rule might be deprecated or renamed - temporarily disabled
  ...
  // NOTE: This rule might be deprecated in @eslint-react/eslint-plugin, commenting out for now
